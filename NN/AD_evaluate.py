...
tf.app.flags.DEFINE_string('eval_dir', '/DeepLearningAD/ADNI/test',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/DeepLearningAD/ADNI/train',
...
def evaluate():
  ...
  with tf.Graph().as_default():
    ...
    images, labels = DeepLearningAD.inputs(eval_data=eval_data)
    ...
    variable_averages = tf.train.ExponentialMovingAverage(
        DeepLearningAD.MOVING_AVERAGE_DECAY)
